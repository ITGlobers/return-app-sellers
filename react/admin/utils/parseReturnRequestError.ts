...
const errorMessages = defineMessages({
  [ORDER_NOT_INVOICED]: {
    id: 'return-app.return-order-details.error.order-not-invoiced',
  },
  [OUT_OF_MAX_DAYS]: {
    id: 'return-app.return-order-details.error.out-of-max-days',
  },
  E_HTTP_404: {
    id: 'return-app.return-order-details.error.order-not-found',
  },
  FORBIDDEN: {
    id: 'return-app.return-order-details.error.forbidden',
  },
  UNKNOWN_ERROR: {
    id: 'return-app.return-order-details.error.unknown',
  },
})
